...
There are a plethora of options when choosing a VPS host. AWS, Hyper Expert, Linode, Vultr, the list goes on.
Price and server specs will dictate your choice, but as long as the following three reuierments are met then your server should work - 
- Ubuntu 18.04 (you can try with other linux flavors, but Ubuntu 18.04 has proven to be solid in every instance it is used)
- 2vCPU / 4GB of RAM minimum
- No restrictions on incoming traffic (not many VPS hosts have restrictions, but check before buying)

## Step 2 - Get your favorite SSH tool and SSH in.
### Windows - 
[MobaXterm](https://mobaxterm.mobatek.net/download.html "MobaXterm Download")
...
- Hot Name or IP addres is your server IP. 
- SSH connection type
- It should prompt for password on connection

### Mac/Linux
- your local bash terminal would work fine
- open terminal/iTerm and enter `ssh ubuntu@<your server IP>` 
- depending on your host, you may need to enter a password or set up a SSH key that is used in place of a password
...
**Big shoutout to Skymoon, [BrotherPatrix](https://github.com/BrotherPatrix), and [F1r3w477](https://github.com/F1r3w477) as they wrote the bones of this tutorial.**
